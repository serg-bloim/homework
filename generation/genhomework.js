...
hwFactory.addTaskPlan(new AudioNumberTaskFactory(audioCollection, 7, 50), 5)
hwFactory.addTaskPlan(new OptionsTaskFactory(imgs, 20), 4)
hwFactory.addTaskPlan(new SumWithTensFactory(1, 4), 3)
